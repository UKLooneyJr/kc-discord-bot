...
public class UptimeCommandTest {
    ...
    public void test() {
        ...
        assertEquals(
                "1 minute, 1 second",
                uptimeCommand.timeSince(startTime.plus(1L, SECONDS).plus(1L, MINUTES)));
        assertEquals(
                "1 minute, 2 seconds",
                uptimeCommand.timeSince(startTime.plus(2L, SECONDS).plus(1L, MINUTES)));
        assertEquals(
                "2 minutes, 1 second",
                uptimeCommand.timeSince(startTime.plus(1L, SECONDS).plus(2L, MINUTES)));
        assertEquals(
                "1 hour, 1 minute, 1 second",
                uptimeCommand.timeSince(
                        startTime.plus(1L, SECONDS).plus(1L, MINUTES).plus(1L, HOURS)));
        assertEquals(
                "1 hour, 1 minute, 2 seconds",
                uptimeCommand.timeSince(
                        startTime.plus(2L, SECONDS).plus(1L, MINUTES).plus(1L, HOURS)));
        assertEquals(
                "1 hour, 2 minutes, 1 second",
                uptimeCommand.timeSince(
                        startTime.plus(1L, SECONDS).plus(2L, MINUTES).plus(1L, HOURS)));
        assertEquals(
                "2 hours, 1 minute, 1 second",
                uptimeCommand.timeSince(
                        startTime.plus(1L, SECONDS).plus(1L, MINUTES).plus(2L, HOURS)));
        assertEquals(
                "1 hour, 2 minutes, 2 seconds",
                uptimeCommand.timeSince(
                        startTime.plus(2L, SECONDS).plus(2L, MINUTES).plus(1L, HOURS)));
        assertEquals(
                "2 hours, 1 minute, 2 seconds",
                uptimeCommand.timeSince(
                        startTime.plus(2L, SECONDS).plus(1L, MINUTES).plus(2L, HOURS)));
        assertEquals(
                "2 hours, 2 minutes, 1 second",
                uptimeCommand.timeSince(
                        startTime.plus(1L, SECONDS).plus(2L, MINUTES).plus(2L, HOURS)));
        assertEquals(
                "2 hours, 2 minutes, 2 seconds",
                uptimeCommand.timeSince(
                        startTime.plus(2L, SECONDS).plus(2L, MINUTES).plus(2L, HOURS)));
        assertEquals(
        ...
        assertEquals(
                ...
                uptimeCommand.timeSince(
                        startTime
                                ...
                                .plus(1L, DAYS)));
        assertEquals(
                "1 day, 1 hour, 2 minutes, 1 second",
                uptimeCommand.timeSince(
                        startTime
                                .plus(1L, SECONDS)
                                .plus(2L, MINUTES)
        ...
        assertEquals(
                ...
                uptimeCommand.timeSince(
                        startTime
                                ...
                                .plus(1L, DAYS)));
        assertEquals(
                "2 days, 1 hour, 1 minute, 2 seconds",
                uptimeCommand.timeSince(
                        startTime
                                .plus(2L, SECONDS)
                                .plus(1L, MINUTES)
                                ...
                                .plus(2L, DAYS)));
        assertEquals(
                "1 day, 2 hours, 2 minutes, 1 second",
                uptimeCommand.timeSince(
                        startTime
                                .plus(1L, SECONDS)
                                .plus(2L, MINUTES)
                                ...
                                .plus(1L, DAYS)));
        assertEquals(
                "2 days, 1 hour, 2 minutes, 1 second",
                uptimeCommand.timeSince(
                        startTime
                                .plus(1L, SECONDS)
                                .plus(2L, MINUTES)
                                ...
                                .plus(2L, DAYS)));
        assertEquals(
                "2 days, 2 hours, 1 minute, 1 second",
                uptimeCommand.timeSince(
                        startTime
                                .plus(1L, SECONDS)
                                .plus(1L, MINUTES)
